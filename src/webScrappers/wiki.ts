...
async function main2({ approve, indices, url }: props) {
...
main2({
  url: "https://en.wikipedia.org/wiki/Opinion_polling_for_the_next_Polish_parliamentary_election#President_Andrzej_Duda",
  approve: "Approve",
  indices: {
    "Date(s)conducted": 0,
    "Sample size": 0,
